...
export default function Careers({
    ...
    return (
        ...
        >
            ...
            {/* Hero Section */}
            <section className="relative -mt-16 bg-gradient-to-br from-blue-600 to-blue-800 py-20 pt-32">
                <div className="container mx-auto px-4">
                    <div className="mx-auto max-w-4xl space-y-6 text-center">
                        ...
                        >
                            ...
                            join our growing team of pool service professionals.
                        </motion.p>
                    </div>
                </div>
            </section>
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        ...
                                        fields are required unless marked
                                        optional.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
